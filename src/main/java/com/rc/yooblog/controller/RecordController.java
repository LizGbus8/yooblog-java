...
public class RecordController {
    ...
    @GetMapping("/records")
    @ApiOperation("获取归档列表")
    public ResultVO records(@RequestParam(value = "currentPage", defaultValue = "1", required = false) Integer current, @RequestParam(value = "size", defaultValue = "10", required = false) Integer size){
